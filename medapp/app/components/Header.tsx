  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="text-2xl font-bold text-blue-700">MindCare</span>
      </div>
      <nav className="flex gap-4 items-center">
        ...
        <Link href="/history" className="px-4 py-2 rounded-lg bg-green-100 text-green-700 font-semibold hover:bg-green-200 transition">Past History</Link>
